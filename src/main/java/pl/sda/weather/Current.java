...
public class Current {
    ...
    public Current(String observation_time, int temperature, int weather_code, String[] weather_icons, String[] weather_descriptions, int wind_speed, int wind_degree, String wind_dir, int pressure, int precip, int humidity, int cloudcover, int feelslike, int uv_index, int visibility, String is_day) {
